...
class DConv(nn.Module):
    def __init__(self,in_feat,out_feat):
        ...
        # initialize parameters and weight
        nn.init.xavier_uniform_(self.weight)
        nn.init.zeros_(self.bias)
        
    def forward(self, adj_matrix, input_feat):
        output = torch.matmul(adj_matrix, input_feat)
...
class GCN(nn.Module):
    def __init__(self, in_feats, h_feats, num_classes):
        ...
        self.conv1 = DConv(in_feats, h_feats)
        self.conv2 = DConv(h_feats, num_classes)
...
model = GCN(29, 16, dataset.num_classes)
print("OK")
...
#save parameters
torch.save(model.state_dict(),'PROTEINS_full_model.pth')
