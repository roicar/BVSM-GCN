...
bias_1_time = 0
bias_2_time = 0
numpy_transform_1_A_time = 0
numpy_transform_2_A_time = 0
...
class SparseGCNConv(nn.Module):
    ...
    def forward(self, adj, features):
        ...
        if self.out_feats == 16:
            global numpy_transform_1_A_time
            numpy_transform_1_A_time += (end - start)
        else:
            global numpy_transform_2_A_time
            numpy_transform_2_A_time += (end - start)
...
print("numpy_transform_1_A_time: ", numpy_transform_1_A_time)
print("numpy_transform_2_A_time: ", numpy_transform_2_A_time)
