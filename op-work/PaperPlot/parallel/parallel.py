...
def Data_power2_random_TEST():
    ...
    MM = [0.024,0.094,0.285,0.663,1.325]
    MM_P = [0.78,0.73,0.79,1.136,0.9]
    ...
    a6 = plt.bar(x+0.1, MM_P, 0.2, color='#35B777', label='MM_P', align='center')
    
    plt.legend(labels=['MM','MM_P'], loc='upper left', fontsize=14)
    
    plt.xticks(x, ['(8,8,8)','(16,16,16)','(24,24,24)','(32,32,32)','(40,40,40)'],size=10,rotation=90)
    plt.ylim(0, 1.4)
    plt.savefig('并行对不同维度矩阵乘法的性能影响.pdf',format='pdf')
