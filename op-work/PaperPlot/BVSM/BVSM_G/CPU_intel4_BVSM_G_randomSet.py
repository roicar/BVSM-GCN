...
def Optimization_time_nor():
    ...
    '''   
    #Ansor = [0.0128,0.0956,0.12]
    BVSM_B = [0.00473,0.0218,0.0447]
    BVSM_M = [0.00453,0.0206,0.0340]
    BVSM_G = [0.0042,0.0168,0.0307]
    ...
    #a1 = plt.bar(x-0.3, Ansor, 0.2, color='yellow', label='Ansor', align='center')
    ...
    plt.savefig('CPU_intel4_BVSM_G_RandomSets.pdf',format='pdf', dpi=1000)
    plt.show()
