...
def Optimization_time_nor():
    ...
    BVSM_B = [0.0125,0.0161,0.0216,0.0255]
    ...
    '''
    a4 = plt.bar(x-0.1, Ansor, 0.2, color='#30688D', label='AnsorTVM', align='center')
    a5 = plt.bar(x+0.1, BVSM_B, 0.2, color='#35B777', label='BVSM-B', align='center')
    ...
    plt.savefig('GPU_intel4_BVSM_B_randomSets.pdf',format='pdf', dpi=1000)
    plt.show()
