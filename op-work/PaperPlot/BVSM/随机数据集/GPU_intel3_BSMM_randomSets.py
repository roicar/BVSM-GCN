...
def Optimization_time_nor():
    ...
    '''
    #Speedup=(52.43,19.78,162.86,66.67)
    Ansor = [0.215,0.275,0.456,0.500]
    BVSM = [0.0041,0.0139,0.0028,0.0075]
    #Atch = [0.0128,0.0203,0.0196,0.0259]
    #Atch_padToMax = [0.0041,0.0139,0.0033,0.0122]
    #Atch_padGroup = [0.0039,0.0145,0.0028,0.0075]
    ...
    plt.savefig('GPU_intel3_BSMM_randomSets.pdf',format='pdf', dpi=1000)
    plt.show()
