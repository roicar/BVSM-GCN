...
def Data_power2_random_TEST():
    ...
    #y_2 = [0.091,0.091,0.086,0.084]
    y_3 = [52.43,19.78,162.86,66.67]
    ...
    #l2 = plt.scatter(x, y_2, color='green', linewidth='4',marker='*')
    l3 = plt.scatter(x, y_3, color='black', linewidth='3',marker='+')

    #plt.plot(x, y_1, color="deepskyblue", linewidth=3, linestyle='-', label='JJ income')
    #plt.plot(x, y_2, color="green", linewidth=3, linestyle='-', label='JJ income')
    plt.plot(x, y_3, color="black", linewidth=2, linestyle='-', label='JJ income')
    #plt.legend(labels=['[16,16,16]', '[64,64,64]'], loc='upper left', fontsize=10)

    plt.xticks(x, ['D1', 'D2', 'D3', 'D4'],size=10,rotation=0)
    plt.ylim(0, 180)

    plt.savefig("intel3GPUSpeedup.pdf",format='pdf')
