...
def Optimization_time_nor():
    ...
    '''   
    AnsorTVM = [1,1,1,1]
    MKL = [2.45,3.22,3.03,3.81]
    
    BVSM = [2.68,2.77,2.92,2.92]
    #AnsorTVM = [0.161,0.101,0.152,0.260]
    ...
    '''
    a5 = plt.bar(x-0.2, AnsorTVM, 0.2, color='#413E85', label='AnsorTVM', align='center')
    a6 = plt.bar(x, MKL, 0.2, color='#30688D', label='Intel-MKL-vbatch', align='center')
    ...
    plt.savefig('intel3_CPU_BaseLine_TUDataset.pdf',format='pdf', dpi=1000)
    plt.show()
