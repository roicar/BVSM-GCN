...
def mm(M, K, N, dtype):
    ...
    out_i_o_o_i_fused_j_o_o_i_fused = s[out].fuse(out_i_o_o_i, out_j_o_o_i)
    s[out].parallel(out_i_o_o_i_fused_j_o_o_i_fused)
    s[out].pragma(out_i_o_o_i_fused_j_o_o_i_fused, "auto_unroll_max_step", 64)
    s[out].pragma(out_i_o_o_i_fused_j_o_o_i_fused, "unroll_explicit", True)
    s[out].vectorize(out_j_i)
    '''
    #8_8_8 RSRS
    '''
    ...
    s[out].pragma(out_k_o, "auto_unroll_max_step", 64)
    s[out].pragma(out_k_o, "unroll_explicit", True)
    s[out].vectorize(out_j_i)
    '''
    ...
    #out_j_o_o_o, out_j_o_o_i = s[out].split(out_j_o_o_i, factor=1)
    #out_k_o, out_k_i = s[out].split(out_k, factor=1)
    s[out].reorder(out_k, out_i_o_i, out_j_o_i, out_i_i, out_j_i)
    s[out].pragma(out_k, "auto_unroll_max_step", 64)
    s[out].pragma(out_k, "unroll_explicit", True)
    s[out].vectorize(out_j_i)
    '''
    ...
    s[out].pragma(out_i_o_o_o_fused, "auto_unroll_max_step", 16)
    ...
    out_i, out_j, out_k = tuple(out.op.axis) + tuple(out.op.reduce_axis)
    out_i_o_i, out_i_i = s[out].split(out_i, factor=1)
    out_i_o_o_i, out_i_o_i = s[out].split(out_i_o_i, factor=25)
    out_i_o_o_o, out_i_o_o_i = s[out].split(out_i_o_o_i, factor=1)
    out_j_o_i, out_j_i = s[out].split(out_j, factor=50)
    out_j_o_o_i, out_j_o_i = s[out].split(out_j_o_i, factor=2)
    out_j_o_o_o, out_j_o_o_i = s[out].split(out_j_o_o_i, factor=1)
    out_k_o, out_k_i = s[out].split(out_k, factor=50)
    s[out].reorder(out_i_o_o_o, out_j_o_o_o, out_i_o_o_i, out_j_o_o_i, out_k_o, out_i_o_i, out_j_o_i, out_k_i, out_i_i, out_j_i)
    out_i_o_o_o_j_o_o_o_fused_i_o_o_i_fused_j_o_o_i_fused = s[out].fuse(out_i_o_o_o, out_j_o_o_o, out_i_o_o_i, out_j_o_o_i)
    #s[out].parallel(out_i_o_o_o_j_o_o_o_fused_i_o_o_i_fused_j_o_o_i_fused)
    s[out].pragma(out_i_o_o_o_j_o_o_o_fused_i_o_o_i_fused_j_o_o_i_fused, "auto_unroll_max_step", 16)
